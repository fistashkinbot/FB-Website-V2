...
Используя FistashkinBot, вы соглашаетесь со следующими условиями:
### 1. Введение
...
- Использование бота в соответствии с [правилами Discord](https://discord.com/terms)
- Не использовать для спама или флуда
- Не пытаться взломать или обойти ограничения бота

{% hint style="danger" %}
Нарушение условий может привести к постоянной блокировке доступа к боту.
{% endhint %}

## Ответственность

Мы не несём ответственности за действия пользователей на серверах, где используется бот.

## Контакты

По вопросам: [discord.gg/H9XCZSReMj](https://discord.gg/H9XCZSReMj)