...
_Последнее обновление: 30.06.2026_

## Сбор данных

FistashkinBot собирает минимально необходимые данные для работы функционала — ID пользователей, ID серверов, игровой прогресс.
...
Мы можем обновлять эту политику. Актуальная версия всегда доступна в документации.
